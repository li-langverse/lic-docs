...
| Artifact | Path | Role |
|----------|------|------|
| Library | `packages/li-studio/src/lib.li` | Compose/paint shell, sim hooks, MCP dispatch |
| Demo binary | `packages/li-studio/src/main.li` → `build/li-studio-demo` | Present loop, profile env |
...
```bash
lic check packages/li-studio/li-tests/smoke/studio_shell_demo.li
...
lic check packages/li-studio/li-tests/smoke/studio_mcp_tools.li
