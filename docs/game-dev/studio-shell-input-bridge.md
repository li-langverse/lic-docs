...
| `packages/li-studio/li-tests/smoke/studio_shell_demo.li` | Per-frame `studio_handle_studio_key` in shell demo |
...
- PH-GD-1 shell demo: `packages/li-studio/examples/studio_shell_demo.toml`
